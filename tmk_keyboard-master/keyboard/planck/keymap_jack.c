...
[0] = KEYMAP( /* Jack */
  ...
  F15,  A,    S,    D,    F,    G,    H,    J,    K,    L,    SCLN,  ENT,
  TAB,  Z,    X,    C,    V,    B,    N,    M,    COMM, DOT,  UP,    RALT,
  LSFT, LCTL, LGUI, LALT, FN2,     SPC,     FN1,  RCTL, LEFT, DOWN,  RGHT),
[1] = KEYMAP( /* raise  */
    TRNS, F1,   F2,   F3,   F4,   F5,   F6,   F7,   F8,   F9,   F10,   DEL,
    TRNS, MINS, FN21, EQL,  FN16, FN23, FN24, SLSH, BSLS, FN12, FN11,  TRNS,
    TRNS, FN20, LBRC, RBRC, FN28, TRNS, TRNS, HOME, END,  TRNS, TRNS,  TRNS,
    TRNS, TRNS, TRNS, TRNS, TRNS,    TRNS,     TRNS, LSFT, RSFT, PAUS, TRNS),
[2] = KEYMAP( /* lower */
  TRNS, 1,    2,    3,    4,    5,    6,    7,    8,    9,    0,    TRNS,
  TRNS, FN10, FN29, FN22, FN30, FN17, FN15, FN18, FN19, QUOT, FN13, TRNS,
  TRNS, FN14, PAUS, PSCR, GRV,  TRNS, TRNS, PGUP, PGDN, TRNS, TRNS, TRNS,
